                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="about-text">
                            ...
                            <p><strong>One of the serious issues faced by our modern world is environmental pollution, and
                                    it is one the most significant challenges that the world is facing in our day.</strong>
                            </p>
                            <p>Environmental pollution has existed for centuries. But, it began to be a severe issue
                                following the industrial revolution in the 19th century. Pollution generally takes place
                                when pollutants pollute the natural surroundings and it can bring about changes that affect
                                our everyday lifestyles unfavorably. </p>
                            <a href="#">Contact Us</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="eco-box">
                                    ...
                                    <p> Lorem ipsum dolor amet consectetur adipiscing elit, sed eiusmod tempor incididunt ut
                                        labore et dolore. </p>
                                </div>
                            </div>
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                <div class="eco-box">
                                    ...
                                    <h5> Fund Raising </h5>
                                    <p>Who has any right to find fault with a man who chooses to enjoy a pleasure that has
                                        no annoying consequences. </p>
                                </div>
                            </div>
                        </div>
                    </div>
